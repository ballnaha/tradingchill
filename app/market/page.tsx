                    ...
                    <Paper sx={{ p: 4, borderRadius: 4, bgcolor: 'rgba(30, 41, 59, 0.4)', border: '1px solid rgba(255,255,255,0.05)', height: '100%' }}>
                        ...
                        <Box sx={{ mt: 4, p: 3, borderRadius: 3, bgcolor: 'rgba(255,255,255,0.02)', textAlign: 'center' }}>
                            ...
                            <Typography variant="h5" sx={{
                                ...
                                {sentiment === 'POSITIVE' ? '🚀 ตลาดแข็งแกร่ง มีแรงซื้อ!' : sentiment === 'NEGATIVE' ? '⚠️ ระวัง ตลาดผันผวนสูง' : '⚖️ รอดูท่าที ตลาดยังนิ่ง'}
                            </Typography>
                            <Typography variant="body2" sx={{ mt: 1.5, color: 'text.secondary', lineHeight: 1.6 }}>
                                {sentiment === 'POSITIVE' ? 'แรงซื้อครอบคลุมตลาด หุ้นที่มีสัญญาณ Bullish มีโอกาสต่อเนื่อง' :
                                    sentiment === 'NEGATIVE' ? 'แรงขายเริ่มกระจายไปหลายกลุ่ม ข้อมูลชี้ว่าความเสี่ยงอยู่ในระดับสูง' :
                                        'ราคาแกว่งในกรอบแคบ สัญญาณเทคนิคยังไม่ชัดเจน'}
                            </Typography>
                        </Box>
                    </Paper>
                </Box>
                    ...
                    <Stack spacing={4}>
                        ...
                        <Box>
                            ...
                            <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2.5, fontSize: '0.75rem' }}>
                                วิเคราะห์ความแข็งแกร่งของแต่ละกลุ่มธุรกิจ เปรียบเทียบสัญญาณของ Sector ETFs ใน S&P 500
                            </Typography>
